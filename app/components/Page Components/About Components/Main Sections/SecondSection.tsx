  ...
  <section className="grid grid-rows-[repeat(6,calc(50vh-2rem))] place-items-center gap-4 overflow-hidden leading-7 md:grid-cols-2 md:grid-rows-[repeat(3,100vh)]">
    ...
    <div id="FirstDiv" className="row-start-1 h-full place-content-center md:col-start-2">
      <FadeInEffect delay={2.5} className="textSmall">
        ...
        <br />
        After getting my degree, I worked in Finance where I realized I was looking for something where <span className="text-techBlue">freedom</span>
        , <span className="text-techBlue">creativity</span> and <span className="text-techBlue">independence</span> feel more rewarding.
      </FadeInEffect>
    </div>
    <FadeInEffect
