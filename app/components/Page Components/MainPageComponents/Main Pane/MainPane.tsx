...
export default function MainPane({ className }: { className?: string }) {
  return (
    <section className={cn('flex min-h-60 flex-col space-y-10 p-10 text-center', className)}>
      <header>
        {' '}
        <h1 className="ml-12 md:ml-0 flex max-w-[90vw] flex-col space-y-2 md:max-w-[70vw]">
          <AutomateOnce className="self-center titleResponsive font-semibold uppercase " />
        </h1>
      </header>
      <p className="space-y-2">
        <span className="block text-pretty">Streamline your workflows, make data-driven decisions, and elevate your business</span>
