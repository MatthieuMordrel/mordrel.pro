...
export function GlobeDemo() {
  ...
  const globeConfig = {
    ...
    globeColor: '#062056',
    showAtmosphere: true,
    atmosphereColor: '#E6E6FA', //Light Blue: #ADD8E6, Sky Blue: #87CEEB, Pale Turquoise: #AFEEEE, Light Cyan: #E0FFFF, Lavender: #E6E6FA
  ...
  const colors = ['#CC8CA4', '#F6999A', '#9E829C', 'NotDisplayed'] //['#06b6d4', '#3b82f6', '#6366f1'] = cyan, blue, indigo, Teal: #008080, Coral: #FF7F50, techPurple: 9E829C
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div ref={myRef} className="relative flex h-full w-full flex-col items-center justify-center md:flex-row">
      <div className="relative h-full w-full overflow-hidden md:h-96 lg:h-full">
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-40 h-40 w-full select-none bg-gradient-to-b from-transparent to-paneGrey" />
