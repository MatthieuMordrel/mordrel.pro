  ...
  return (
    <GradientBorder>
      <div className="hover-pane pane relative h-[150px] w-full overflow-hidden bg-paneGrey p-4 transition-all duration-300 ease-in-out hover:h-[350px]">
        ...
        {bottomContent && <div className="absolute inset-0 mb-4 flex flex-col justify-end px-4 py-4 opacity-0 transition-opacity duration-300 ease-in-out hover:opacity-100">{bottomContent}</div>}
      </div>
    </GradientBorder>
  )
}
